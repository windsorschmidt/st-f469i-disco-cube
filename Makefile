##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.7.1] date: [Sun Mar 29 20:40:31 PDT 2020] 
##########################################################################################################################
...
flash: $(BUILD_DIR)/$(TARGET).elf
	openocd -f /usr/share/openocd/scripts/board/st_nucleo_f4.cfg -c init -c targets -c 'reset halt' -c 'flash write_image erase build/st-f469i-disco-cube.elf' -c 'reset halt' -c 'reset run' -c shutdown
